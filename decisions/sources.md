# Source reachability probe — session 1 (2026-09-16)
...
| UK curve | BoE latest (zip, current-month daily) | 200 | 323,736 |  | `https://www.bankofengland.co.uk/-/media/boe/files/statistics/yield-curves/latest-yield-curve-data.zip` |
...
| JP curve | MOF kickoff URL (moved) | 404 | 20,347 |  | `https://www.mof.go.jp/english/policy/jgbs/reference/interest_rate/jgbcme_all.csv` |
...
| FR curve | ECB euro AAA spot 10y | 200 | 3,159,845 | 2004-09-06 → 2026-09-15 | `https://data-api.ecb.europa.eu/service/data/YC/B.U2.EUR.4F.G_N_A.SV_C_YM.SR_10Y?format=csvdata` |
...
| IT curve | ECB euro all-issuers spot 10y | 200 | 3,192,373 | 2004-09-06 → 2026-09-15 | `https://data-api.ecb.europa.eu/service/data/YC/B.U2.EUR.4F.G_N_C.SV_C_YM.SR_10Y?format=csvdata` |
| IT check | ECB IRS Italy 10y (monthly, convergence rate) | 200 | 153,283 | 1991-03 → 2026-08 | `https://data-api.ecb.europa.eu/service/data/IRS/M.IT.L.L40.CI.0000.EUR.N.Z?format=csvdata` |
| IT curve | Banca d'Italia BDS (national) | 200 | 121,343 |  | `https://infostat.bancaditalia.it/inquiry/home?spyglass/taxo:CUBESET=/PUBBL_00/PUBBL_00_02_00&ep:LC=EN` |
| Short 3m | FRED TB3MS (USD) | 200 | 17,849 | 1934-01-01 → 2026-08-01 | `https://fred.stlouisfed.org/graph/fredgraph.csv?id=TB3MS` |
| Short 3m | FRED IR3TIB01GBM156N (GBP) | 200 | 15,956 | 1957-01-01 → 2026-01-01 | `https://fred.stlouisfed.org/graph/fredgraph.csv?id=IR3TIB01GBM156N` |
| Short 3m | FRED IR3TIB01JPM156N (JPY) | 200 | 5,621 | 2002-04-01 → 2026-07-01 | `https://fred.stlouisfed.org/graph/fredgraph.csv?id=IR3TIB01JPM156N` |
| Short 3m | FRED IR3TIB01CAM156N (CAD) | 200 | 19,641 | 1956-01-01 → 2026-08-01 | `https://fred.stlouisfed.org/graph/fredgraph.csv?id=IR3TIB01CAM156N` |
| Short 3m | FRED IR3TIB01EZM156N (EUR) | 200 | 11,669 | 1994-01-01 → 2026-01-01 | `https://fred.stlouisfed.org/graph/fredgraph.csv?id=IR3TIB01EZM156N` |
| Short policy | BIS CBPOL JP (monthly policy rate) | 200 | 1,979,669 | 1946-01 → 2026-08 | `https://stats.bis.org/api/v2/data/dataflow/BIS/WS_CBPOL/1.0/M.JP?format=csv` |
| Short policy | BIS CBPOL XM (euro area) | 200 | 192,803 | 1999-01 → 2026-08 | `https://stats.bis.org/api/v2/data/dataflow/BIS/WS_CBPOL/1.0/M.XM?format=csv` |
| FX | FRED EXUSUK (USD per GBP) | 200 | 12,048 | 1971-01-01 → 2026-08-01 | `https://fred.stlouisfed.org/graph/fredgraph.csv?id=EXUSUK` |
| FX | FRED EXJPUS (JPY per USD) | 200 | 13,311 | 1971-01-01 → 2026-08-01 | `https://fred.stlouisfed.org/graph/fredgraph.csv?id=EXJPUS` |
| FX | FRED EXCAUS (CAD per USD) | 200 | 12,048 | 1971-01-01 → 2026-08-01 | `https://fred.stlouisfed.org/graph/fredgraph.csv?id=EXCAUS` |
| FX | FRED EXUSEU (USD per EUR) | 200 | 6,000 | 1999-01-01 → 2026-08-01 | `https://fred.stlouisfed.org/graph/fredgraph.csv?id=EXUSEU` |
...
### UK curve — BoE latest (zip, current-month daily)
_GLC Nominal daily data current month.xlsx_
```
...
_TEC 1 2 3 5 7 10 15 20 25 30 exist; records need a free API key_
```
...
### FR curve — ECB euro AAA spot 10y
_zero; 2004-09 onward; tenors 3M 1Y 2Y 3Y 5Y 7Y 10Y 20Y 30Y all 200_
```
...
### IT curve — ECB euro all-issuers spot 10y
_zero; 2004-09 onward_
```
KEY,FREQ,REF_AREA,CURRENCY,PROVIDER_FM,INSTRUMENT_FM,PROVIDER_FM_ID,DATA_TYPE_FM,TIME_PERIOD,OBS_VALUE,OBS_STA
...
### IT check — ECB IRS Italy 10y (monthly, convergence rate)
_single tenor, check series only_
```
KEY,FREQ,REF_AREA,IR_TYPE,TR_TYPE,MATURITY_CAT,BS_COUNT_SECTOR,CURRENCY_TRANS,IR_BUS_COV,IR_FV_TYPE,TIME_PERIO
...
### IT curve — Banca d'Italia BDS (national)
...
### Short 3m — FRED IR3TIB01GBM156N (GBP)
_OECD 3m interbank, monthly, 1957-_
```
...
### Short 3m — FRED IR3TIB01JPM156N (JPY)
_2002-04 onward only_
```
...
### Short 3m — FRED IR3TIB01CAM156N (CAD)
_1956-_
```
...
### Short 3m — FRED IR3TIB01EZM156N (EUR)
_1994-_
```
...
### Short policy — BIS CBPOL JP (monthly policy rate)
_fallback where FRED 3m is short; US GB CA XM same pattern_
```
...
### Short policy — BIS CBPOL XM (euro area)
```
FREQ,REF_AREA,UNIT_MEASURE,UNIT_MULT,TIME_FORMAT,COMPILATION,DECIMALS,SOURCE_REF,SUPP_INFO_BREAKS,TITLE,TIME_P
